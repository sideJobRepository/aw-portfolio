...
export default function SuperAdminPage() {
  ...
  useEffect(() => {
    ...
    //객실, 스페셜, 환불
    if (
      ["parlor", "special", "refund", "addr"].includes(
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center md:flex-row flex-col">
            ...
            <div className="flex items-center gap-4 mt-2 md:mt-0">
              ...
              <button
                onClick={() => router.push("/")}
                className="px-2 md:px-4 py-2 bg-white text-black rounded-lg font-semibold hover:bg-gray-200 transition-all"
              >
                메인 페이지
              </button>
              <button
                onClick={() => router.push("/admin/dashboard")}
                className="hidden md:block px-2 md:px-4 py-2 bg-white text-black rounded-lg font-semibold hover:bg-gray-200 transition-all"
              >
                일반 대시보드
              </button>
              <button
                onClick={handleLogout}
                className="px-2 md:px-4 py-2 bg-gray-800 text-white rounded-lg font-semibold hover:bg-gray-700 transition-all"
              >
                로그아웃
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex gap-0 md:gap-8 justify-center md:justify-start flex-wrap md:flex-nowrap">
            ...
            <button
              ...
              className={`py-1 md:py-4 px-2 font-semibold border-b-4 transition-all ${activeTab === "questions" ? "border-black text-black" : "border-transparent text-gray-500 hover:text-black"}`}
            >
              질문 관리
            </button>
            <button
              onClick={() => setActiveTab("users")}
              className={`py-1 md:py-4 px-2 font-semibold border-b-4 transition-all ${activeTab === "users" ? "border-black text-black" : "border-transparent text-gray-500 hover:text-black"}`}
            >
              사용자 관리
            </button>
            <button
          ...
          <div>
            <div className="flex justify-between items-center mb-6">
              <div className="flex items-center gap-4 md:justify-center md:gap-1 md:flex-col">
                <h2 className="hidden md:block text-2xl font-bold text-black">
                  질문 목록
                </h2>
                <select
                  value={selectedPortfolio}
                  onChange={(e) => setSelectedPortfolio(e.target.value)}
                  className="px-4 py-2 md:px-0 md:py-1 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black"
                >
              ...
              <table className="min-w-full divide-y-2 divide-gray-200">
                <thead className="bg-gray-100">
                  <tr>
                    ...
                    <th className="px-4 md:px-6 py-3 text-left text-xs font-bold text-black uppercase tracking-wider">
                      이메일
                    </th>
                    <th className="px-6 py-3 text-left text-xs font-bold text-black uppercase tracking-wider">
                      역할
        ...
        >
          <div className="bg-white rounded-lg p-8 max-w-2xl w-full border-2 border-black max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleCreateOrUpdateQuestion} className="space-y-4">
              ...
              {questionForm.questionType === "id_password" && (
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-semibold text-black mb-2">
                      플레이스홀더 1 (아이디)
                      ...
                      <table className="w-full">
                        ...
                        <tbody className="divide-y divide-gray-200">
                          {group.submissions.map((submission: any) => (
                            ...
                            >
                              <td className="px-1 md:px-6 py-4 text-sm font-semibold text-black">
                              ...
                              <td className="px-1 md:px-6 py-4 text-sm text-gray-900">
                                {new Date(
                                  submission.isDraft
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-gray-50 border-b-2 border-black">
                    <tr>
                      <th className="px-1 md:px-6 py-4 text-left text-sm font-bold text-black">
                        카테고리명
                      </th>
                      <th className="px-1 md:px-6 py-4 text-left text-sm font-bold text-black">
                        슬러그
